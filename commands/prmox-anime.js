...
async function sendAnimu(sock, chatId, message, type) {
    ...
    async function convertMediaToSticker(mediaBuffer, isAnimated) {
        ...
        const json = {
            ...
            'sticker-pack-name': 'Anime Stickers : 𝙿𝚁𝙼𝙾✗',
            'emojis': ['🎌']
        };
    ...
    if (data.link) {
        ...
        if (isGifLink || isImageLink) {
            ...
            react: { text: '⁉️', key: message.key }
                ...
                console.error('⚠️ 𝙴𝚛𝚛𝚘𝚛 𝚌𝚘𝚗𝚟𝚎𝚛𝚝𝚒𝚗𝚐 𝚖𝚎𝚍𝚒𝚊 𝚝𝚘 𝚜𝚝𝚒𝚌𝚔𝚎𝚛:', error);
            }
        }
        ...
        try {
            await sock.sendMessage(
                chatId,
                { image: { url: link }, caption: `𝚊𝚗𝚒𝚖𝚎: ${type}` },
                { quoted: message }
            );
            return;
        } catch {}
    ...
    try {
        if (!sub) {
            ...
            try {
                ...
                await sock.sendMessage(chatId, { text: `⚔️ 𝚄𝚜𝚊𝚐𝚎:: .animu <type>\nTypes: ${apiTypes}` }, { quoted: message });
            } catch {
        ...
        if (!supported.includes(sub)) {
            ...
            await sock.sendMessage(chatId, { text: `❌ 𝚄𝚗𝚜𝚞𝚙𝚙𝚘𝚛𝚝𝚎𝚍 𝚝𝚢𝚙𝚎: ${sub}. 𝚃𝚛𝚢 𝚘𝚗𝚎 𝚘𝚏: ${supported.join(', ')}` }, { quoted: message });
            return;
        }
        ...
        await sock.sendMessage(chatId, { text: '⚠️ 𝙰𝚗 𝚎𝚛𝚛𝚘𝚛 𝚘𝚌𝚌𝚞𝚛𝚛𝚛𝚍 𝚠𝚑𝚒𝚕𝚎 𝚏𝚎𝚝𝚌𝚑𝚒𝚗𝚐 𝚊𝚗𝚒𝚖𝚞...' }, { quoted: message });
    }
}
