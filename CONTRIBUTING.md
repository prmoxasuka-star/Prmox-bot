# Contributing to ᴘʀᴍᴏ✗ ʙᴏᴛ  v1

Thank you for considering contributing to ᴘʀᴍᴏ✗ ʙᴏᴛ! Your contributions help make this project better for everyone.  
...
2. **Clone the Repository** – Clone your fork locally using:  
    ```sh
    git clone https://github.com/YOUR_USERNAME/prmox-bot.git
    cd prmox-bot
    ```
