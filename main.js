...
const { autotypingCommand, isAutotypingEnabled, handleAutotypingForMessage, handleAutotypingForCommand, showTypingAfterCommand } = require('./commands/owner-autotyping');
...
const ttsCommand = require('./commands/prmox-tts');
const { tictactoeCommand, handleTicTacToeMove } = require('./commands/tictactoe');
const { incrementMessageCount, topMembers } = require('./commands/tools-topmembers');
...
const tagCommand = require('./commands/admin-tag');
const tagNotAdminCommand = require('./commands/admin-tagnotadmin');
const hideTagCommand = require('./commands/admin-hidetag');
const jokeCommand = require('./commands/joke');
const quoteCommand = require('./commands/quote');
const factCommand = require('./commands/fact');
const weatherCommand = require('./commands/prmox-weather');
const newsCommand = require('./commands/prmox-news');
const kickCommand = require('./commands/kick');
const simageCommand = require('./commands/simage');
const attpCommand = require('./commands/tools-attp');
const { startHangman, guessLetter } = require('./commands/hangman');
const { startTrivia, answerTrivia } = require('./commands/trivia');
const { complimentCommand } = require('./commands/compliment');
const { insultCommand } = require('./commands/insult');
const { eightBallCommand } = require('./commands/eightball');
const { lyricsCommand } = require('./commands/prmox-lyrics');
...
const { welcomeCommand, handleJoinEvent } = require('./commands/admin-welcome');
const { goodbyeCommand, handleLeaveEvent } = require('./commands/goodbye');
const githubCommand = require('./commands/gc-github');
const { handleAntiBadwordCommand, handleBadwordDetection } = require('./lib/antibadword');
const antibadwordCommand = require('./commands/admin-antibadword');
const { handleChatbotCommand, handleChatbotResponse } = require('./commands/chatbot');
const takeCommand = require('./commands/tools-take');
const { flirtCommand } = require('./commands/tools-flirt');
const characterCommand = require('./commands/character');
const wastedCommand = require('./commands/tools-wasted');
const shipCommand = require('./commands/ship');
const groupInfoCommand = require('./commands/gc-groupinfo');
const resetlinkCommand = require('./commands/admin-resetlink');
const staffCommand = require('./commands/staff');
const unbanCommand = require('./commands/unban');
const emojimixCommand = require('./commands/emojimix');
const { handlePromotionEvent } = require('./commands/promote');
const { handleDemotionEvent } = require('./commands/demote');
const viewOnceCommand = require('./commands/tools-viewonce');
...
const instagramCommand = require('./commands/prmox-instagram');
const facebookCommand = require('./commands/prmox-facebook');
const spotifyCommand = require('./commands/prmox-spotify');
const playCommand = require('./commands/prmox-play');
const tiktokCommand = require('./commands/prmox-tiktok');
const songCommand = require('./commands/prmox-song');
const aiCommand = require('./commands/prmox-ai');
const urlCommand = require('./commands/prmox-url');
const { handleTranslateCommand } = require('./commands/translate');
const { handleSsCommand } = require('./commands/tools-ss');
const { addCommandReaction, handleAreactCommand } = require('./lib/reactions');
const { goodnightCommand } = require('./commands/goodnight');
const { shayariCommand } = require('./commands/shayari');
const { rosedayCommand } = require('./commands/roseday');
const imagineCommand = require('./commands/imagine');
const videoCommand = require('./commands/prmox-video');
const sudoCommand = require('./commands/sudo');
const { miscCommand, handleHeart } = require('./commands/misc');
const { animeCommand } = require('./commands/prmox-anime');
...
global.channelLink = "https://whatsapp.com/channel/0029VbCSgYg545uyq548Tv0G";
global.ytch = "ᴘʀᴍᴏ✗ ᴡᴇʙ";
...
async function handleMessages(sock, messageUpdate, printLog) {
    try {
        ...
        if (message.message?.buttonsResponseMessage) {
            ...
            if (buttonId === 'channel') {
                await sock.sendMessage(chatId, { 
                    text: '📢 𝚆𝚑𝚊𝚝𝚜𝚊𝚙𝚙 𝙲𝚑𝚊𝚗𝚗𝚎𝚕 :\nhttps://whatsapp.com/channel/0029VbCSgYg545uyq548Tv0G' 
                }, { quoted: message });
                return;
        ...
        switch (true) {
                ...
                if (isGroup) {
                    ...
                    if (isSenderAdmin || message.key.fromMe) {
                        ...
                        await sock.sendMessage(chatId, {                                react: { text: '🥴', key: message.key },
                               text: '❕ 𝚂𝚘𝚛𝚛𝚢, 𝚘𝚗𝚕𝚢 𝚐𝚛𝚘𝚞𝚙 𝚊𝚍𝚖𝚒𝚗𝚜 𝚌𝚊𝚗 𝚞𝚜𝚎 𝚝𝚑𝚒𝚜 𝚌𝚘𝚖𝚖𝚊𝚗𝚍...', ...channelInfo }, { quoted: message });
                    }
                } else {
                    await sock.sendMessage(chatId, {                     text: '🙃', key: message.key },
            ...
            case userMessage.startsWith('.antibadword'):
                ...
                if (!isBotAdmin) {
                    await sock.sendMessage(chatId, { 
                           ...
                           text: '🪄 𝙱𝚘𝚝 𝚖𝚞𝚜𝚝 𝚋𝚎 𝚊𝚍𝚖𝚒𝚗 𝚝𝚘 𝚞𝚜𝚎 𝚝𝚑𝚒𝚜 𝚏𝚎𝚊𝚝𝚞𝚛𝚎...', ...channelInfo }, { quoted: message });
                    return;
                }
            ...
            case userMessage.startsWith('.chatbot'):
                ...
                if (!chatbotAdminStatus.isSenderAdmin && !message.key.fromMe) {
                    await sock.sendMessage(chatId, { 
                           react: { text: '🥴', key: message.key },
                           text: '❗ 𝙾𝚗𝚕𝚢 𝚊𝚍𝚖𝚒𝚗𝚜 𝚘𝚛 𝚋𝚘𝚝 𝚘𝚠𝚗𝚎𝚛 𝚌𝚊𝚗 𝚞𝚜𝚎 𝚝𝚑𝚒𝚜 𝚌𝚘𝚖𝚖𝚊𝚗𝚍....', ...channelInfo }, { quoted: message });
                    return;
                }
        ...
        console.error('❌ 𝙴𝚛𝚛𝚘𝚛 𝚒𝚗 𝚖𝚎𝚜𝚜𝚊𝚐𝚎 𝚑𝚊𝚗𝚍𝚕𝚎𝚛:', error.message);
        // Only try to send error message if we have a valid chatId
        if (chatId) {
            await sock.sendMessage(chatId, {
                react: { text: '🥴', key: message.key },
                text: '❗ 𝙵𝚊𝚒𝚕𝚎𝚍 𝚝𝚘 𝚙𝚛𝚘𝚌𝚎𝚜𝚜 𝚌𝚘𝚖𝚖𝚊𝚗𝚍...',
                ...channelInfo
            });
        }
    }
